    ...
    <div class="container mt-5">
        <div class="row align-items-center mb-5">
            <div class="col-lg-6">
                ...
                <h1 class="display-3 font-playfair mb-4 text-dark">A Legacy of Taste</h1>
        ...
        <div class="row mt-5 pt-5">
            <div class="col-lg-4 text-center mb-5 mb-lg-0">
                ...
                <h4 class="font-playfair text-dark">Fresh Ingredients</h4>
            ...
            <div class="col-lg-4 text-center mb-5 mb-lg-0">
                ...
                <h4 class="font-playfair text-dark">Exquisite Drinks</h4>
            ...
            <div class="col-lg-4 text-center">
                ...
                <h4 class="font-playfair text-dark">Expert Staff</h4>
